...
{
    // Here a little module that returns HTML
        ...
        private const string HTML =
            ...
            <html>
                ...
                <body>
                    ...
                    <div id='yetAnotherId' class='message2'>A not so important message</div>
                <body>
            </html>";
    }

    public class CC_BodyAssertionsTests
    {
        ...
        [Fact]
        public void should_be_able_to_show_off_my_small_contribution_to_the_framework()
        {
            // Assert
            ResponseWithHtml
                .Body[".message2"]
                .ShouldExistExactly(3); // Huh? Huh? Just what you'd wanted, right? :P
        }
    }
